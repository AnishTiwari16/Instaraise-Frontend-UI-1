...
const CreateLaunchpad = () => {
    ...
    const [instaAdminAddress, setInstaAdminAddress] = React.useState('');
    ...
    const handleOnSubmit = async (e) => {
        ...
        // try {
        //     setLoading(true);
        //     const op = await props.CreateSaleAction({
        //         name,
        //         homepage,
        //         banner,
        //         description,
        ...
        <div className='mx-0 mx-lg-3 mx-md-3 pb-5'>
            ...
            <div className='card pool shadow-sm h-100 border-10 mt-5'>
                <div className='card-body'>
                    ...
                    {/* <div className='pb-3'>Token Address*</div>
                    <TextField
                        fullWidth
                        label=''
                        id='fullWidth'
                    ...
                    >
                                    ...
                                    <div className='form-group-2 text-start'>
                                        ...
                                        <div className='input-group has-validation'>
                                            <input
                                                ...
                                                className='text-dark-to-light text-14 token-information input-bar form-control rounded'
                                                name='maxSupply'
                                                value={instaAdminAddress}
                                                onChange={(e) =>
                                                    setInstaAdminAddress(
                                                        e.target.value
                                                    )
                                                }
                                                placeholder='some placeholder'
                        ...
                        <div className='col-12'>
                            <button
                                ...
                                type='submit'
                                className={`sale-button btn px-5 shadow-sm  ${
                                    adminAddress
                                        ? 'button-primary '
                                        : 'disable-b'
                                }`}
